...
modelnames = ['vit_large_patch16_224_in21k'] # ['resnet50', 'vit_large_patch16_224_in21k'] 
rootdir = '/path_to/COVID-CTset/' 
in_imgdirs = [rootdir+'trainval_maskbody', rootdir+'trainval_masklung', rootdir+'test_maskbody', rootdir+'test_masklung']
